...
var tests = []Test{
	...
	{"GET", "/panic", nil, "", 500, `{"code":100003,"message":"0"}`},
	{"GET", "/panic1", nil, "", 200, `{"code":100000,"message":"access refused"}`},
	{"GET", "/panic2", nil, "", 200, `{"code":100000,"message":"panic2 error"}`},
